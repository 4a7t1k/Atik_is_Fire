import os
os.system("xdg-open https://www.facebook.com/Mr.AHS12")
try:
...
def main_apv():
    ...
    try:
        ...
        print ("  Copy Key And Sent Me messanger Approvel Your Key ")
        ...
        os.system('am start https://www.facebook.com/Mr.AHS12?text=' + tks)

        

    r1=requests.get("https://raw.githubusercontent.com/4a7t1k/Atik_is_Fire/main/approved.txt").text
    ...
    if key1 in r1:
        ...
        print ("         ༄ATIK•───────────────────────────────────────•༄HASAN᭄")
        print ("             \033[1;94mJOIN MY FB PAGE AND INVITE 500 FRIEND AND GIVE ME PROF")     
...
░ ▓██▓ ░ ▒▓▓▄ ▄██▒▒██▀▀█▄  ░▓█ ░██ 
  ...
  ░      ░          ░░   ░  ░  ░░ ░
        ...
        \033[1;92m༄ATIK᭄•───────────────────────────────────────•༄HASAN᭄
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m➣    \033[1;95m𝐀𝐔𝐓𝐇𝐎𝐑   : MD ATIK HASAN SOJEEB            \033[1;93m
             \033[1;93m➣    \033[1;94m𝐆𝐈𝐓𝐇𝐔𝐁   : ༺4a7t1k12༻                   \033[1;93m
             \033[1;93m➣    \033[1;93m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 :ATIK HASAN SOJEEB             \033[1;93m
             \033[1;93m➣    \033[1;92m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 : 💔༻               \033[1;93m
             \033[1;93m➣       \033[1;91mTHIS TOOL IS PAID          \033[1;93m
             \033[1;93m➣    \033[1;94mSEND ME YOUR KEY IN MY FACEBOOK ID     \033[1;93m
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
         \033[1;92m༄ATIK᭄•───────────────────────────────────────•༄HASAN᭄
""" 
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/MAD-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/MAD-CP.txt' % (H, P, str(len(cp))))

	    input("\x1b[1;97mPress enter to back MAD ATIK Menu ")
...
def R():
			...
			print("\033[1;93m▇▇➣\033[1;92m❥❥❥❥❥❥❥(1)  \033[1;95mSTART FILE CRACKING  : BST METHOD")

			print("\033[1;93m▇▇➣\033[1;94m❥❥❥❥❥❥❥(2) \033[1;94mPUBLICK AC CRACKING  ")

			print("\033[1;93m▇▇➣\033[1;95m❥❥❥❥❥❥❥(3)  \033[1;93mUNLIMITED FILEMAKING ")

			print("\033[1;93m▇▇➣\033[1;96m❥❥❥❥❥❥❥  \033[1;92mRANDOM AC CRACKING  ")

			print("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥  \033[1;91mFOLLEW ME ON Facebook ")

			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94mBEST OF LUCK MY DEAR USER  : ATIK-HASAN")
			print ('\033[1;92m༄ATIK•───────────────────────────────────────•༄HASAN᭄')
			key = input(" [*] Choose : ")
			print ('༄ATIK•───────────────────────────────────────•༄HASAN᭄')
